...
<script>
    var service = 'http://localhost:8080/project'
...
<table class="table">
    ...
    <tr>
        <td>Get All projects - <code><strong>GET</strong></code></td>
        <td>/project/all</td>
        <td>
    ...
    <tr>
        <td>Get project by id - <code><strong>GET</strong></code></td>
        <td>/project/get/{id}</td>
        <td>
            id: <input id="getProjectByID" value="1"/>
            <button type="button" onclick="RestGet($('#getProjectByID').val())">try</button>
        </td>
    </tr>
    <tr>
        <td>add new project - <code><strong>POST</strong></code></td>
        <td>/project/add</td>
        <td>
